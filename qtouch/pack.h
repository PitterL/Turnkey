...
*/
/* Firmware version*/
#define PROJECT_CODE 0x56323010	/*V20, 1.0*/

/* Fuse content */
// BOD level 2(2.6v Sampled 1Khz at Sleep, Enabled at Active), OSC 16Mhz, NVM protect after POR, EEPROM erased
#define FUSES_CONTENT {0x00, 0x46, 0x7D, 0xFF, 0x00, 0xF6, 0xFF, 0x00, 0x00, 0xFF, 0xC5 }	/*BYTE order, ignore set as NULL or the value*/
